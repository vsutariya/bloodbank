    ...
    <div class="container cont">
        ...
        <table class="table table-responsive table-striped rounded mb-5">
            ...
            <div>
                ...
                else echo '<b style="color:white;background-color:red; font-family:Georgia; font-size: 25px; padding:11px;  border-radius: 25px 50px;"> ..... This Blood Sample is Not Available ..... </b>'; 
            }
            ?>
            </div>
            <br> <br>
